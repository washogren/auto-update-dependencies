...
describe('extractGitHubSlug', () => {
  it('returns owner/repo for a github URL', () => {
    expect(
      extractGitHubSlug('https://github.com/your-org/your-dependency')
    ).toBe('your-org/your-dependency')
  })
  ...
  it('throws when the URL is empty or unparseable', () => {
    ...
    expect(() => extractGitHubSlug('not-a-url')).toThrow(
      /Could not extract a GitHub/
    )
  })
})
