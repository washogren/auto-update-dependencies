...
describe('normalizeRepoUrl', () => {
  it('strips git+ prefix and .git suffix', () => {
    expect(normalizeRepoUrl('git+https://github.com/foo/bar.git')).toBe('https://github.com/foo/bar')
  })
...
describe('extractGitHubSlug', () => {
  it('returns owner/repo for a github URL', () => {
    expect(extractGitHubSlug('https://github.com/your-org/your-dependency')).toBe('your-org/your-dependency')
  })
